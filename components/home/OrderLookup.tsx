    ...
    <section id="takip" className="py-32 bg-[#0a0a0a] relative overflow-hidden">
      <div className="container-premium relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Search Bar */}
          <div className="glass p-2 rounded-full border border-white/5 max-w-xl mx-auto mb-16 flex items-center pr-2">
            <form onSubmit={handleSearch} className="flex-1 flex items-center px-6">
              ...
              <input 
                ...
                className="bg-transparent border-none text-white focus:outline-none focus:ring-0 w-full placeholder:text-white/20 font-light"
              />
            </form>
            <button 
              onClick={handleSearch}
              disabled={loading}
              className="bg-[var(--accent-gold)] hover:bg-[var(--accent-gold-light)] text-black px-8 py-3 rounded-full font-bold text-sm transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(201,169,110,0.3)]"
            >

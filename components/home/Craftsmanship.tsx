...
export default function Craftsmanship() {
  ...
  return (
    <section ref={containerRef} className="py-32 relative bg-[var(--background)] overflow-hidden">
      {/* Background glow */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {materials.map((mat, idx) => (
            <div key={idx} className="craft-card group relative p-[1px] rounded-3xl overflow-hidden glass">
              {/* Animated border gradient */}
              <div className={`absolute inset-0 bg-gradient-to-br ${mat.color} opacity-0 group-hover:opacity-100 transition-opacity duration-700`} />
              
              <div className="relative h-full bg-[#0a0a0a]/90 backdrop-blur-xl p-10 rounded-3xl border border-white/5 group-hover:border-transparent transition-colors duration-700">
                ...
                <p className="text-white/50 leading-relaxed font-light">{mat.desc}</p>

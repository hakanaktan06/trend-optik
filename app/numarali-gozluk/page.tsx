...
export const metadata: Metadata = {
  title: "Numaralı Gözlük Çerçeveleri | Trend Optik Mersin",
  description: "Mersin numaralı gözlük ve optik çerçeve modelleri. Yüz tipinize uygun kaliteli asetat ve titanyum çerçeveler, uzman göz ölçümü eşliğinde.",
  alternates: { canonical: "https://trendoptikmersin.com/numarali-gozluk" }
};

export default async function NumaraliGozlukPage() {
  const allProducts = await getAllProductsServer();
  const products = allProducts.filter(p => p.category === "klasik");
  ...
  return (
    <main className="min-h-screen bg-[#050505] pt-32 pb-20">
      ...
      <div className="container-premium">
        ...
        <div className="mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Numaralı <span className="text-white/20 italic">Çerçeveler</span></h1>
          <p className="text-white/40 max-w-2xl font-light text-lg">
            Mersin'de yüz tipinize ve tarzınıza en uygun numaralı optik çerçeveyi bulmanız için geniş koleksiyonumuzu ve uzman optisyenlerimizi deneyimleyin.
          </p>
        </div>
